...
export function StartupServiceFactory(startupService: StartupService, mfService: MicrofrontendService): () => Promise<void> {
  return () => {
    startupService.load();
...
const APPINIT_PROVIDES = [
  StartupService,
  {
    ...
    deps: [StartupService, MicrofrontendService],
    multi: true
  }
];
// #endregion
