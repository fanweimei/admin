...
import { buildRoutes } from "../shared/utils/route-utils";
...
export class MicrofrontendService {
    ...
    loadConfig(): Microfrontend[] {
        return [
            {
                // For Loading
                remoteEntry: "http://localhost:4201/standard.js",
                remoteName: "standard",
                exposedModule: "MessageModule",

                // For Routing, enabling us to ngFor over the microfrontends and dynamically create links for the routes
                displayName: "Standard",
                routePath: "standard/message",
                ngModuleName: "MessageModule",
            },
        ];
    }
}